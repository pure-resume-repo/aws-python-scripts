...
def check_ami_status(ami_id):
    image = "Checking if AMI is ready to use, please wait........"
    while image != ami_id:
        ...
        if len(response["Images"]) > 0:
            ...
            print("AMI not ready yet, please wait...........")
        time.sleep(10)
...
def stop_new_running_instance(instance):
    ...
    print("Checking EC2 state, I will stop the instance once it is running")
    while state != "running":
        ...
        if len(response["InstanceStatuses"]) > 0:
            ...
            print("EC2 not ready to stop yet, please wait.......")

    print("State: ", state)
    time.sleep(10)

    print("Will now stop the instance!")
    response = ec2_client.stop_instances(InstanceIds=[instance_id[0]])
    print("State: stopped")
...
def __main__():
    ...
    print(
        "New Created ami {} and created instance {} from it".format(
            ami_id, new_instance_id
        )
    )
